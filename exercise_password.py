def password():
    ...
    if len(contraseña) < 8 and not ("0" in contraseña or "1" in contraseña or "2" in contraseña or "3" in contraseña or "4" in contraseña or "5" in contraseña or "6" in contraseña or "7" in contraseña or "8" in contraseña or "9" in contraseña):
        print("Contraseña muy corta") and print("Debe contener un numero")
    else:
